...
public class MainActivityAsync extends AsyncTask<Pair<Context, String>, Void, String> {
...
//                        }
//                    })
                    .setRootUrl("https://gradleproject100.appspot.com/_ah/api/")
                    .setApplicationName("GradleProject100");
