 ...
 * on 2016-10-02 at 15:01:43 UTC 
 * Modify at your own risk.
 */

package com.udacity.gradle.buiditbigger.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://GradleProject100.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.udacity.gradle.buiditbigger.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.udacity.gradle.buiditbigger.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.udacity.gradle.buiditbigger.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.udacity.gradle.buiditbigger.backend.myApi.model.MyBean.class);
